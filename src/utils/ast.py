...
#    [2, 2, '-'] => <class 'ArithmGraph'> ( https://wmpics.pics/pm-V1E24LUG.html )
#
# argumenty:
#    1) tokens: <class 'list'> - lista tokenów w notacji posfiksowej
#
# zwraca:
#    <class 'ArithmGraph'> - objekt reprezentujący graph arytmetyczny
#

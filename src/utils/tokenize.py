...
# Funkcja: tokenize
# -----------------
# przetwarza tekstowe wyrarzenie arytmetyczne w listę (tablicę) tokenów (liczby, zmięnna, operator)
#    "2 + 2" => [2, '-', 2]
#
# argumenty:
...
#
# zwraca:
#    <class 'list'> - listę tokenów (notacja infiksowa, tak jak wprowadził użytkownik)
#
def tokenize(expr):
    tokens = []
    buffer = []
